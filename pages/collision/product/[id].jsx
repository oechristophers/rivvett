...
export async function getServerSideProps(context) {
  ...
  // If no gallery found for the specific gender, fall back to unisex
  if (gallery.length === 0 && genderName !== 'unisex') {
    gallery = await Gallery.find({ gender: 'unisex' }).exec();
  }
...
{
  /* <div class="min-h-screen w-full z-10 md:w-[43%] sm:min-h-auto md:flex sm:w-full  mt-8 sm:relative ">
              <div className=' w-[15%] flex flex-col h-[auto] gap-3'>
             <div className='bg-slate-500 h-[70px] w-[70%] '></div>
             <div className='bg-slate-500 h-[70px] w-[70%] '></div>
             <div className='bg-slate-500 h-[70px] w-[70%] '></div>
              </div>
              <div className='w-[85%] bg-slate-500 min-h-[inherit]'>
