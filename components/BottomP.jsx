    ...
    <Div>
      {path === "men" && (
        <P>
          ...
          sleek tonal shades. If you&apos;re hunting for trousers and denim, explore
          everything from on-trend cargos to classic fits in the denim
          collection. Keep your shoe game strong with a selection of versatile
          kicks, perfect for finishing off your look. Whether you&apos;re looking to
          stay cozy or active, Rivvett&apos;s got you covered. Time to scroll!
        </P>
      )}
      {path === "women" && (
        <P>
          ...
          athleisure? Rivvett&apos;s sportswear edit has got you covered, delivering
          performance-focused pieces in bold prints and vibrant hues. Time to
          hit checkout!
        </P>
      )}
    </Div>
