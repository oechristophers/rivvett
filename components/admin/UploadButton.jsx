...
export default function UploadButton({setIsUploading, setImages, images=[], resizeAndEdit }) {
    ...
    const uploadImages = async (ev) => {
        ...
        if (selectedFiles?.length > 0) {
          ...
          //resize using canvas
          const resizeImage = (file, intrinsicWidth, intrinsicHeight, renderWidth, renderHeight) => {
            return new Promise((resolve) => {
              ...
              reader.onload = function (e) {
                ...
                img.onload = function () {
                  ...
                  const shouldResize = img.width !== intrinsicWidth || img.height !== intrinsicHeight;
          ...
          const removeBackground = (file, targetColor = '#e7e7e7', targetColors = ['#ffffff', '#dbdbdb'], tolerance = 20) => {
            return new Promise((resolve) => {
              const reader = new FileReader();
              reader.onload = function (e) {
                const img = new Image();
                img.onload = function () {
                  ...
                  for (let i = 0; i < data.length; i += 4) {
                    ...
                    const isTargetColor = targetRgbArray.some(([tr, tg, tb]) => 
          ...
          for (const file of selectedFiles) {
            if (resizeAndEdit) {
              ...
              // Resize the image
              const { blob } = await resizeImage(blobWithNoBackground, 750, 958, 140, 179); // Intrinsic: 750x958, Render: 140x179
